...
#define LD_IND_BC_A ((unsigned char) 0x02)
...
#define LD_IND_A16_SP ((unsigned char) 0x08)
#define ADD_HL_BC ((unsigned char) 0x09)
#define LD_A_IND_BC ((unsigned char) 0x0A)
...
#define LD_IND_DE_A ((unsigned char) 0x12)
...
#define LD_A_IND_DE ((unsigned char) 0x1A)
...
#define LD_IND_HL_PLUS_A ((unsigned char) 0x22)
...
#define LD_A_IND_HL_PLUS ((unsigned char) 0x2A)
...
#define LD_IND_HL_MINUS_A ((unsigned char) 0x32)
...
#define LD_A_IND_HL_MINUS ((unsigned char) 0x3A)
